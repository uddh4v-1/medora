...
export function HeroSection() {
  return (
    <section className="flex flex-col items-center px-6 pb-28 pt-16 text-center md:pt-20">
      ...
      <h1 className="landing-fade-rise landing-delay-1 max-w-4xl text-balance text-5xl font-semibold leading-[1.05] tracking-tight text-foreground md:text-6xl lg:text-7xl">
        Run your clinic
        <br />
        without{" "}
        <span className="landing-coral-accent text-brand-coral">the chaos.</span>
      </h1>

      <p className="landing-fade-rise landing-delay-2 mt-7 max-w-2xl text-pretty text-base leading-relaxed text-muted-foreground md:text-[17px]">
      ...
      <div className="landing-fade-rise landing-delay-3 mt-10 flex flex-col items-center gap-3 sm:flex-row">
        <Button
          asChild
      ...
      <div className="landing-stats-grid mt-20 grid grid-cols-3 gap-x-12 gap-y-2 text-center sm:gap-x-20">
        {heroStats.map((stat) => (
          <div key={stat.label} className="landing-fade-rise">
